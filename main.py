    ...
    try:
        ...
        if numero_deudas >= 1:
            ...
            try:
                ...
                # Período: 2026
                # Vencimiento: entre 01/05/2026 y 20/05/2026
                fecha_vencimiento_inicio = datetime(2026, 5, 1).date()
                fecha_vencimiento_fin = datetime(2026, 5, 20).date()
...
print("   - Vencimiento filtrado: 01/05/2026 a 20/05/2026")
